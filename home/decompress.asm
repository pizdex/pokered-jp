; bankswitches and runs _DecompressSpriteData
...
DecompressSpriteData::
	...
	xor a
	ld [MBC1SRamBank], a
	call _DecompressSpriteData
	pop af
	ldh [hLoadedROMBank], a
	ld [MBC1RomBank], a
	ret

; initializes necessary data to load a sprite and runs DecompressSpriteDataLoop
_DecompressSpriteData::
	ld hl, sSpriteBuffer1
	ld c, LOW(2 * SPRITEBUFFERSIZE)
	ld b, HIGH(2 * SPRITEBUFFERSIZE)
	xor a
	call ByteFill ; clear sprite buffer 1 and 2
	ld a, 1
...
; Decompresses a chunk from the sprite input data stream (pointed to at wd0da) into sSpriteBuffer1 or sSpriteBuffer2
; each chunk is a 1bpp sprite. A 2bpp sprite consist of two chunks which are merged afterwards
; note that this is an endless loop which is terminated during a call to MoveToNextBufferPosition by manipulating the stack
DecompressSpriteDataLoop::
	ld hl, sSpriteBuffer1
